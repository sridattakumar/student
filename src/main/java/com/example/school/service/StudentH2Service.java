...
public class StudentH2Service implements StudentRepository {
    ...
    public Student addStudent(Student student){
        ...
        return db.queryForObject("select * from student where studentName=? and gender=? and standard=?", new StudentRowMapper(), student.getStudentName(), student.getGender(), student.getStandard());
    }
